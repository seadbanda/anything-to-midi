...
extern uint8_t Midi_Note_Off(uint8_t _u8_channel, uint8_t _u8_note, uint8_t _u8_velocity){
...
*/
extern uint8_t Midi_Note_On(uint8_t _u8_channel, uint8_t _u8_note, uint8_t _u8_velocity){
...
*/
extern uint8_t Midi_Poly_Key_Pressure(uint8_t _u8_channel, uint8_t _u8_note, uint8_t _u8_velocity){
...
*/
extern uint8_t Midi_Control_Change(uint8_t _u8_channel, uint8_t _u8_controller, uint8_t _u8_value){
...
*/
extern uint8_t Midi_Program_Change(uint8_t _u8_channel, uint8_t _u8_program){
...
*/
extern uint8_t Midi_Channel_Pressure(uint8_t _u8_channel, uint8_t _u8_pressure){
...
*/
extern uint8_t Midi_Pitch_Wheel(uint8_t _u8_channel, uint16_t _u16_value){
...
extern uint8_t Midi_Sound_Off(uint8_t _u8_channel){
  return OK;
}


extern uint8_t Midi_Reset_All_Controllers(uint8_t _u8_channel){
...
extern uint8_t Midi_Local_Control(uint8_t _u8_channel){
...
extern uint8_t Midi_All_Notes_Off(uint8_t _u8_channel){
